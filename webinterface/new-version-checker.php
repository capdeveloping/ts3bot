<?php
    ...
    if (array_key_exists("VersionChecker", $functions)) {
        $newVersionKey = $functions["VersionChecker"];
    }
    $saved = FALSE;
    if (isset($_POST['save'])){

        $config[$newVersionKey . "_version_check_time"] = $_POST['version_check_time'];
                            ...
                            <form class="form-horizontal" data-toggle="validator" name="update" method="POST">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4 input-group">
                                        ...
                                        <input class="form-control" id="inputTime" type="text" name="version_check_time" placeholder="enter update intervall" value=<?php echo '"' . $config[$newVersionKey . "_version_check_time"] . '"' ?> required/>
                                    </div>
                                </div>
